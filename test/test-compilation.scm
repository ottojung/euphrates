...
%use (alist->hashmap hashmap->alist hashmap-clear! hashmap-copy hashmap-count hashmap-delete! hashmap-foreach hashmap-has? hashmap-map hashmap-merge hashmap-merge! hashmap-ref hashmap-set! make-hashmap multi-alist->hashmap) "./src/ihashmap.scm"
%use (hashset->list hashset-add! hashset-clear! hashset-delete! hashset-difference hashset-equal? hashset-foreach hashset-has? hashset-intersection hashset-length hashset-map hashset-ref hashset-union list->hashset make-hashset vector->hashset) "./src/ihashset.scm"
...
%use (make-profun-RFC profun-RFC-add-info profun-RFC-continue-with-inserted profun-RFC-eval-inserted profun-RFC-set-continuation profun-RFC-what profun-RFC?) "./src/profun-RFC.scm"
%use (profun-accept profun-accept-alist profun-accept-ctx profun-accept-ctx-changed? profun-accept? profun-ctx-set profun-set) "./src/profun-accept.scm"
...
%use (profun-create-database profun-database-add-rule! profun-database-copy profun-eval-query profun-run-query) "./src/profun.scm"
