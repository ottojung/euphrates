...
%use (make-profun-abort profun-abort-add-info profun-abort-insert profun-abort-iter profun-abort-modify-iter profun-abort-reset profun-abort-set-iter profun-abort-type profun-abort-what profun-abort?) "./src/profun-abort.scm"
...
%use (profun-iterator-constructor profun-iterator-copy profun-iterator-db profun-iterator-env profun-iterator-insert! profun-iterator-query profun-iterator-reset! profun-iterator-state set-profun-iterator-query! set-profun-iterator-state!) "./src/profun-iterator.scm"
