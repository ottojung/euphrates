...
%use (make-profun-RFC profun-RFC-add-info profun-RFC-continue-with-inserted profun-RFC-eval-inserted profun-RFC-modify-continuation profun-RFC-set-continuation profun-RFC-what profun-RFC?) "./src/profun-RFC.scm"
%use (make-profun-abort profun-abort-add-info profun-abort-continue-with-inserted profun-abort-eval-inserted profun-abort-modify-continuation profun-abort-set-continuation profun-abort-type profun-abort-what profun-abort?) "./src/profun-abort.scm"
...
%use (profun-create-database profun-database-add-rule! profun-database-copy profun-database? profun-eval-query profun-run-query) "./src/profun.scm"
