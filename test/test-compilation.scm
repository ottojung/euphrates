...
%use (descriptors-registry-add! descriptors-registry-decolisify-name descriptors-registry-get) "./src/descriptors-registry.scm"
...
%use (path-without-extensions) "./src/path-without-extensions.scm"
...
%use (make-falsy-profun-database make-profun-database profun-database-add! profun-database-copy profun-database-extend profun-database-falsy? profun-database-get profun-database-get-all profun-database-handle profun-database-handler profun-database-rules profun-database-set-all! profun-database?) "./src/profun-database.scm"
...
%use (profun-create-database profun-create-falsy-database profun-eval-query profun-eval-query/boolean profun-iterate profun-next profun-next/boolean) "./src/profun.scm"
...
%use (deserialize-builtin/short serialize-builtin/short) "./src/serialization-builtin-short.scm"
...
%use (deserialize/sexp/natural serialize/sexp/natural) "./src/serialization-sexp-natural.scm"
%use (deserialize/sexp/short serialize/sexp/short) "./src/serialization-sexp-short.scm"
