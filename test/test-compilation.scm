...
(cond-expand
 (guile
  (define-module (test-compilation)
    ...
    :use-module ((euphrates call-with-input-string) :select (call-with-input-string))
    :use-module ((euphrates call-with-output-string) :select (call-with-output-string))
    ...
    :use-module ((euphrates compose) :select (compose))
    ...
    :use-module ((euphrates euphrates-list-sort) :select (euphrates:list-sort))
    ...
    :use-module ((euphrates irregex) :select (irregex irregex-dfa irregex-dfa/search irregex-extract irregex-flags irregex-fold irregex-lengths irregex-match irregex-match-data? irregex-match-end-chunk irregex-match-end-index irregex-match-names irregex-match-num-submatches irregex-match-start-chunk irregex-match-start-index irregex-match-subchunk irregex-match-substring irregex-match-valid-index? irregex-match/chunked irregex-names irregex-new-matches irregex-nfa irregex-num-submatches irregex-replace irregex-replace/all irregex-reset-matches! irregex-search irregex-search/chunked irregex-search/matches irregex-split irregex? make-irregex-chunker maybe-string->sre sre->irregex string->irregex string->sre))
