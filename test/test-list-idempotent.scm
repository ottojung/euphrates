...
(assert= (list-idempotent/left equalp (list 'x 'y 'z))
         (list 'x 'y 'z))

;; Test Case 4: Test with numbers and greater-than predicate
(assert= (list-idempotent/left greaterp (list 5 4 3 6 2 7))
         (list 5 3 6 7))
...
(assert= (list-idempotent/left equalp (list (list 'a 'b) (list 'a 'b) (list 'c 'd)))
...
(assert= (list-idempotent/left equalp (list (list 1 (list 2)) (list 1 (list 2)) (list 3 (list 4))))
...
(assert= (list-idempotent/left equalp (list 1 "1" 2 "2" 1 "1"))
         (list 1 "1" 2 "2"))
