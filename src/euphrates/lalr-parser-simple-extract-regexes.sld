...
(define-library
  (euphrates lalr-parser-simple-extract-regexes)
  (export lalr-parser/simple-extract-regexes)
  (import
  ...
  (cond-expand
    (guile (import (only (guile) include-from-path))
           (begin
             (include-from-path
               "euphrates/lalr-parser-simple-extract-regexes.scm")))
    (else (include
            "lalr-parser-simple-extract-regexes.scm"))))
