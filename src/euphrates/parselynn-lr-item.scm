...
(define-type9 <parselynn:lr-item>
  ...
  (left-hand-side parselynn:lr-item:left-hand-side)       ;; A non-terminal.
  (dot-position parselynn:lr-item:dot-position)           ;; An natural number <= length of right-hand-side.
  (right-hand-side parselynn:lr-item:right-hand-side)     ;; A list of terminals and non-terminals. Production.
  (lookahead parselynn:lr-item:lookahead)                 ;; A terminal or eof symbol.
