...
(define (jwsxcu pred lst)
  ;; The `jwsxcu` function takes two arguments:
  ...
  ;; the output upon repeated application. Similarly, `jwsxcu` will ensure that applying the same function
  ;; repeatedly will yield the same list after the first application, as duplicate elements will have been removed.
  ;;
  ;; Example usage:
  ;; (jwsxcu equal? (list 1 2 1 4 1))
  ;; will return
  ;; (list 1 2 4 1)
