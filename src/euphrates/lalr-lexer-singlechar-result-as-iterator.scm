...
(define (lalr-lexer/singlechar-result:as-iterator result)

  (define this
    (lalr-lexer/singlechar-result-struct:lexer result))

  (define input-type
    (lalr-lexer/singlechar-result-struct:input-type result))

  (define input
    (lalr-lexer/singlechar-result-struct:input result))
